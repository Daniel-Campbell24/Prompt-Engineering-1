...
def generate_response(prompt):
    ...
    response = openai.Completion.create(
        ...
        top_p=0.8,  # Filter out low probability tokens for sampling
        frequency_penalty=0.0,  # Adjust the penalty applied to already generated tokens
        presence_penalty=0.0  # Adjust the penalty for new tokens based on their presence in the prompt
    )
